...
public class Zadatak1PETLJA {
	...
	public static void main(String[] args) {
		...
		List<WebElement> lista = (driver.findElements(By.xpath("//*[@class = 'sc-ivTmOn iltlXU']/div/div[1]")));
...
//		driver.findElement(By.xpath("//*[@class = 'sc-gYMRRK gMENHs cropper-modal']/div/div[2]/button")) .click();
		for (int i = 0; i < lista.size(); i++) {
			lista.get(i).click();
			driver.findElement(By.xpath("//*[contains(text() , 'Add Image')]")).click();
